        ...
        <div>
            <div className="bg-[url('/images/web.jpg')] bg-cover bg-center h-screen w-full">
                <div className="bg-black/70 h-full w-full lg:flex lg:justify-center lg:items-center">
                    ...
                    <div>
                        <img src="/images/webpages.png" alt="webpages" className="mt-10 md:mt-0 md:max-w-xl lg-mt-0"/>
                    </div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center sm:pt-6 md:pt-6 py-4 px-6 md:px-12 lg:px-24 bg-slate-950">
                <div className="my-6 lg:w-1/2">
                    ...
                    <p className="pb-4 text-gray-300 text-justify">At MA Software Solution, we specialize in creating modern, responsive, and high-performance websites for businesses of all sizes. Our goal is to help brands establish a strong online presence through innovative design and reliable development solutions.</p>
                    <p className="pb-4 text-gray-300 text-justify">We combine creativity, technology, and strategy to deliver websites that are visually appealing, user-friendly, and optimized for performance. From business websites to custom web applications, we focus on providing solutions that drive growth and improve customer engagement.</p>
                    <p className="pb-4 text-gray-300 text-justify">Our team is committed to delivering quality work, clean code, and exceptional user experiences. We believe every business deserves a professional digital presence that reflects its vision and builds trust with customers.</p>
                    <p className=" text-gray-300 text-justify">At MA Software Solution, customer satisfaction is our priority. We work closely with clients to understand their goals and turn their ideas into powerful digital experiences that help their business succeed online.</p>
                </div>
                 <div>
            ...
            <div className="bg-slate-950">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-6 md:mx-12 lg:mx-24 py-2 gap-6">
                    <div className="bg-slate-900 border border-blue-900 rounded-2xl hover:border-cyan-400 hover:-translate-y-2 md:h-auto w-full lg:max-w-sm">
                        <p className="lg:py-8 py-2.5 px-4 md:py-3 text-white text-justify">“MA Software Solution created a professional and modern website for our business. Their team was responsive, skilled, and delivered exactly what we needed.”</p>
                    ...
                    <div className="lg:max-w-sm w-full bg-slate-900 border border-blue-900 rounded-2xl hover:border-cyan-400 hover:-translate-y-2">
                        <p className="lg:py-8 py-2.5 px-4 text-white text-justify">“The website design exceeded our expectations. Everything was clean, fast, and mobile-friendly. Highly recommended for web development services.”</p>
                        <h1 className="lg:px-4 lg:pb-4 pb-2 px-4 text-white">Sarah Williams</h1>
                    </div>
                    <div className="lg:max-w-sm w-full bg-slate-900 border border-blue-900 rounded-2xl hover:border-cyan-400 hover:-translate-y-2">
                        <p className="lg:py-8 py-2.5 px-4 text-white text-justify">“Working with MA Software Solution was a great experience. They understood our vision perfectly and built a website that improved our online presence.”</p>
